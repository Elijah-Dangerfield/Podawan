...
fun Text(
    ...
    typography: TypographyResource = LocalTextConfig.current.typography ?: PodawanTheme.typography.Default,
...
internal fun TypographyResource.toStyle(
    ...
    val fallbackColor = LocalTextConfig.current.color.takeOrElse(LocalContentColor.current.takeOrElse(PodawanTheme.colors.text))
...
private fun TextPreviewProvided() {
    Preview(
        ...
        ProvideTextConfig(
            config = TextConfig(
                typography = PodawanTheme.typography.Default
                    .copy(
                        fontWeight = FontWeight.ExtraLight
                    ),
                color = PodawanTheme.colors.accent,
