...
fun BasicTextField(
    ...
    color: Color = PodawanTheme.colors.text.color,
    disabledColor: Color = PodawanTheme.colors.textDisabled.color,
    ...
    val textSelectionColors = TextSelectionColors(
        handleColor = PodawanTheme.colors.accent.color,
        backgroundColor = PodawanTheme.colors.accent.color.copy(alpha = 0.4F)
    )
