...
import com.dangerfield.features.inAppMessaging.internal.update.InstallInAppUpdateImpl
...
class CompleteInAppUpdateImplTest {
    ...
    private val completeInAppUpdateImpl = InstallInAppUpdateImpl(fakeInAppUpdateManager)
